package cbcho.kafka.streams.chapter4.util.serde;


import com.google.gson.reflect.TypeToken;

import cbcho.kafka.streams.chapter4.collectors.FixedSizePriorityQueue;
import cbcho.kafka.streams.chapter4.model.ClickEvent;
import cbcho.kafka.streams.chapter4.model.CustomerTransactions;
import cbcho.kafka.streams.chapter4.model.Purchase;
import cbcho.kafka.streams.chapter4.model.PurchaseKey;
import cbcho.kafka.streams.chapter4.model.PurchasePattern;
import cbcho.kafka.streams.chapter4.model.RewardAccumulator;
import cbcho.kafka.streams.chapter4.model.ShareVolume;
import cbcho.kafka.streams.chapter4.model.StockPerformance;
import cbcho.kafka.streams.chapter4.model.StockTickerData;
import cbcho.kafka.streams.chapter4.model.StockTransaction;
import cbcho.kafka.streams.chapter4.model.TransactionSummary;
import cbcho.kafka.streams.chapter4.util.collection.Tuple;
import cbcho.kafka.streams.chapter4.util.serializer.JsonDeserializer;
import cbcho.kafka.streams.chapter4.util.serializer.JsonSerializer;
