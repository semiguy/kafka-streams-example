package cbcho.kafka.streams.chapter3.util.serde;


import com.google.gson.reflect.TypeToken;

import cbcho.kafka.streams.chapter3.collectors.FixedSizePriorityQueue;
import cbcho.kafka.streams.chapter3.model.ClickEvent;
import cbcho.kafka.streams.chapter3.model.CustomerTransactions;
import cbcho.kafka.streams.chapter3.model.Purchase;
import cbcho.kafka.streams.chapter3.model.PurchaseKey;
import cbcho.kafka.streams.chapter3.model.PurchasePattern;
import cbcho.kafka.streams.chapter3.model.RewardAccumulator;
import cbcho.kafka.streams.chapter3.model.ShareVolume;
import cbcho.kafka.streams.chapter3.model.StockPerformance;
import cbcho.kafka.streams.chapter3.model.StockTickerData;
import cbcho.kafka.streams.chapter3.model.StockTransaction;
import cbcho.kafka.streams.chapter3.model.TransactionSummary;
import cbcho.kafka.streams.chapter3.util.collection.Tuple;
import cbcho.kafka.streams.chapter3.util.serializer.JsonDeserializer;
import cbcho.kafka.streams.chapter3.util.serializer.JsonSerializer;
